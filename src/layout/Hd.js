  ...
  return (
    <header className='d-flex align-items-center justify-content-center'>
      ...
      <div className="hdtop container d-flex justify-content-between align-items-center">
        <h1 className='order-1 order-lg-0'><a href="/" className='d-flex justify-content-center align-items-center'><Logo width='120' height='60' className='d-none d-lg-block'></Logo><Logomin className='d-block d-lg-none'/></a></h1>
      ...
      <div className="hdbtm container">
        <nav className="gnb d-none d-lg-flex justify-content-between align-items-center">
            <div className='mainmenu position-relative'>
              <Link to={allData.navdata.category.linkto} className='category d-flex justify-content-start align-items-center'><Menuline width='28' height='28' className='me-2'></Menuline>{allData.navdata.category.title}</Link>
      ...
      <Mbtab isOpen={isMenuOpen} toggleMenu={toggleMenu} />
    </header>
  )
}
